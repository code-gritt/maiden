...
const features = [
  {
    ...
    text: "Ask questions in plain English and get instant, accurate answers from your PDFs without searching manually.",
  },
  {
    title: "Smart Metadata Extraction",
    icon: (
      <path d="M14.29 2.614a1 1 0 0 0-1.58-1.228L6.407 9.492l-3.199-3.2a1 1 0 1 0-1.414 1.415l4 4a1 1 0 0 0 1.496-.093l7-9ZM1 14a1 1 0 1 0 0 2h14a1 1 0 1 0 0-2H1Z" />
    ),
    text: "Automatically pull key details like titles, authors, and topics from documents in seconds.",
  },
  {
    ...
    text: "Get concise summaries of lengthy reports, research papers, or contracts instantly.",
  },
  {
    ...
    text: "Run tailored searches and extract exactly the information you need from your PDFs.",
  },
  {
    ...
    text: "Chat with PDFs in multiple languages with accurate translations and localized understanding.",
  },
  {
    title: "Smart Document Linking",
    icon: (
    ...
    text: "Seamlessly connect related PDFs and reference sections for deeper context and faster insights.",
  },
];
        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              mAIden helps you chat with your PDFs smarter and faster
            </h2>
          </div>
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            {features.map((f, i) => (
              <article key={i}>
                ...
                <p className="text-[15px] text-gray-400">{f.text}</p>
              </article>
            ))}
          </div>
        </div>
